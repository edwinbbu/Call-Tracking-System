...
<body id="page-top" class="index">
    ...
    <h4>Employee name:<span style="color: blue">Alan George Philip</span><br>
    Phone number:<span style="color: blue">9446753369</span></h4><br>
    ...
    $result=mysqli_query($con,$sql);
    $tot=mysqli_fetch_row($result);
    echo "<b>Total number of calls:<span style=\"color:blue\">".$tot[0]."</span></b></h4>";
